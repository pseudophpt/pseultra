...
(void *src, void *dest, int size) {
    ...
    *(u32 *)N64_KSEG1_ADDR(N64_PI_DRAM_ADDR_REG) = (u32)dest;
    *(u32 *)N64_KSEG1_ADDR(N64_PI_CART_ADDR_REG) = (u32)src;

    // Write
    *(u32 *)N64_KSEG1_ADDR(N64_PI_WR_LEN_REG) = size - 1;

    // Poll status register
    while (*(u32 *)N64_KSEG1_ADDR(N64_PI_STATUS_REG) && 0x01);
}
