...
#define INT_CAUSE_MASK_SW1 (1 << (INT_CAUSE_SW1 + 8))
#define INT_CAUSE_MASK_SW2 (1 << (INT_CAUSE_SW2 + 8))
#define INT_CAUSE_MASK_RCP (1 << (INT_CAUSE_RCP + 8))
#define INT_CAUSE_MASK_CART (1 << (INT_CAUSE_CART + 8))
#define INT_CAUSE_MASK_PRENMI (1 << (INT_CAUSE_PRENMI + 8))
#define INT_CAUSE_MASK_RDBR (1 << (INT_CAUSE_RDBR + 8))
#define INT_CAUSE_MASK_RDBW (1 << (INT_CAUSE_RDBW + 8))
#define INT_CAUSE_MASK_TIMER (1 << (INT_CAUSE_TIMER + 8))

#define INT_CAUSE_MASK_ALL (INT_CAUSE_MASK_TIMER | INT_CAUSE_MASK_RDBW | INT_CAUSE_MASK_RDBR | INT_CAUSE_MASK_PRENMI | INT_CAUSE_MASK_CART | INT_CAUSE_MASK_RCP | INT_CAUSE_MASK_SW2 | INT_CAUSE_MASK_SW1)
...
#define INT_RCP_CAUSE_MASK_SP (1 << (INT_RCP_CAUSE_SP * 2))
#define INT_RCP_CAUSE_MASK_SI (1 << (INT_RCP_CAUSE_SI * 2))
#define INT_RCP_CAUSE_MASK_AI (1 << (INT_RCP_CAUSE_AI * 2))
#define INT_RCP_CAUSE_MASK_VI (1 << (INT_RCP_CAUSE_VI * 2))
#define INT_RCP_CAUSE_MASK_PI (1 << (INT_RCP_CAUSE_PI * 2))
#define INT_RCP_CAUSE_MASK_DP (1 << (INT_RCP_CAUSE_DP * 2))

#define INT_RCP_CAUSE_MASK_ALL (INT_RCP_CAUSE_MASK_DP | INT_RCP_CAUSE_MASK_PI | INT_RCP_CAUSE_MASK_VI | INT_RCP_CAUSE_MASK_AI | INT_RCP_CAUSE_MASK_SI | INT_RCP_CAUSE_MASK_SP)

#define INT_RCP_CAUSE_UNMASK_SP (1 << ((INT_RCP_CAUSE_SP * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_SI (1 << ((INT_RCP_CAUSE_SI * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_AI (1 << ((INT_RCP_CAUSE_AI * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_VI (1 << ((INT_RCP_CAUSE_VI * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_PI (1 << ((INT_RCP_CAUSE_PI * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_DP (1 << ((INT_RCP_CAUSE_DP * 2) + 1))
#define INT_RCP_CAUSE_UNMASK_ALL (INT_RCP_CAUSE_UNMASK_DP | INT_RCP_CAUSE_UNMASK_PI | INT_RCP_CAUSE_UNMASK_VI | INT_RCP_CAUSE_UNMASK_AI | INT_RCP_CAUSE_UNMASK_SI | INT_RCP_CAUSE_UNMASK_SP)

#define INT_RCP_CAUSE_BIT_SP (1 << (INT_RCP_CAUSE_SP))
#define INT_RCP_CAUSE_BIT_SI (1 << (INT_RCP_CAUSE_SI))
#define INT_RCP_CAUSE_BIT_AI (1 << (INT_RCP_CAUSE_AI))
#define INT_RCP_CAUSE_BIT_VI (1 << (INT_RCP_CAUSE_VI))
#define INT_RCP_CAUSE_BIT_PI (1 << (INT_RCP_CAUSE_PI))
#define INT_RCP_CAUSE_BIT_DP (1 << (INT_RCP_CAUSE_DP))
...
#define KUSEG_ADDR(x) (KUSEG | x)
#define KSEG0_ADDR(x) (KSEG0 | x)
#define KSEG1_ADDR(x) (KSEG1 | x)
#define KSSEG_ADDR(x) (KSSEG | x)
#define KSEG3_ADDR(x) (KSEG3 | x)
